...
import { AgentConfigurationOptions } from "@/app/(protected)/[lang]/playground/agents/page";
...
function ChatSidebarInternal({ ...props }: ChatSideBarProps) {
    ...
    const [isDefaultAgent, setIsDefaultAgent] = useState<boolean>(
        agentData?.slug.toLowerCase() === "khoj" ? true : false,
    );
                            ...
                            <SidebarMenu className="p-0 m-0">
                                <SidebarMenuItem key={"model"} className="list-none">
                                    <ModelSelector
                                        ...
                                        onSelect={(model, userModification) =>
                                            handleModelSelect(model.name, userModification)
                                        }
                                        initialModel={
