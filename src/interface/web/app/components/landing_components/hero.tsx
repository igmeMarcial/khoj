      ...
      <div className="flex w-full flex-col items-center space-y-8 px-4 py-36 text-center xl:px-0">
        ...
        <div>
          <BlurFade delay={BLUR_FADE_DELAY * 2}>
            <h1 className="text-4xl md:leading-[89px] sm:text-5xl font-light tracking-tight md:text-7xl max-w-4xl mx-auto">
              <span className="relative md:whitespace-nowrap font-normal  md:font-light ">
                <span
                  className="z-10"
                  style={{
                    background:
                ...
                >
                  {dictionary.customer_service_agents}{" "}
                </span>
                <Brush />
              </span>
              {dictionary.ai_for_businesses}
            </h1>
          </BlurFade>
